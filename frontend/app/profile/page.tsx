...
export default function ProfilePage() {
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
            ...
            <motion.main
                className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-10 md:px-8"
                variants={container}
                initial="hidden"
                animate="visible"
            >
                <motion.header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between" variants={item}>
                    <div className="flex flex-col gap-2">
                        <h1 className="text-4xl font-semibold tracking-tight">Profile</h1>
                        <p className="text-slate-300">Manage your account details, preferences, and security settings.</p>
                    </div>
                    <Link
                        href="/dashboard"
                ...
                <motion.section className="grid auto-rows-fr grid-cols-1 gap-6 md:grid-cols-2" variants={container}>
                    <motion.div className="h-full" variants={item}>
                        <Card className="flex h-full flex-col bg-slate-900/80 border-slate-800">
                            <CardHeader>
                                <CardTitle>Account</CardTitle>
                                <CardDescription>Core profile information visible to clinicians and teammates.</CardDescription>
                            </CardHeader>
                    ...
                    <motion.div className="h-full" variants={item}>
                        <Card className="flex h-full flex-col bg-slate-900/80 border-slate-800">
                            <CardHeader>
                                ...
                                <CardDescription>Adjust UI and notification defaults for your account.</CardDescription>
                            </CardHeader>
                            <CardContent className="flex flex-1 flex-col space-y-4">
                                <div className="space-y-2">
                                ...
                                <Button className="mt-auto w-fit" size="sm">Update preferences</Button>
                            </CardContent>
                        </Card>
                    </motion.div>
                    ...
                    <motion.div className="h-full" variants={item}>
                        <Card className="flex h-full flex-col bg-slate-900/80 border-slate-800">
                            ...
                            <CardContent className="flex flex-1 flex-col space-y-3 text-sm text-slate-200">
                                <p>Last password change: <span className="text-slate-100">12 Jan 2026</span></p>
                                <p>Last login (device): <span className="text-slate-100">25 Mar 2026 · Chrome · London, UK</span></p>
                                <div className="mt-auto flex gap-3 pt-2">
                                    <Button size="sm" variant="outline">Change password</Button>
                                    <Button size="sm" variant="ghost">View active sessions</Button>
                                </div>
                            </CardContent>
                        </Card>
                    </motion.div>
                    ...
                    <motion.div className="h-full" variants={item}>
                        <Card className="flex h-full flex-col bg-slate-900/80 border-slate-800">
                            ...
                            <CardContent className="flex flex-1 flex-col space-y-2 text-sm text-slate-200">
